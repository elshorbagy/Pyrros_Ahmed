                    ...
                    case "POST":
                        {
                            ...
                            return new OkObjectResult(await _accountService.AddNewAccount(request));
                        }

                    case "GET":
                        accountId = req.Query["id"];
                        accountId.ValidateString();
                        return new OkObjectResult(await _accountService.GetAccountById(int.Parse(accountId)));
                    default:
